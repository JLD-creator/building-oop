...
public class BuildingAppMenu {
    ...
    public void run(){
        ...
        do {
            ...
            System.out.println("2. Devolver apartamento ");
            System.out.println("3. Mostrar apartamentos de una planta");
            System.out.println("4. Devolver propietarios segun planta y puerta");
            System.out.println("5. Mostrar datos segun planta y puerta");
            System.out.println("6. Mostrar propietarios de apartamentos segun puerta y planta");
